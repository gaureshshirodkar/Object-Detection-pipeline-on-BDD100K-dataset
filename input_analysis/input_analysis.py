...
def main():
    TRAIN_LABELS_PATH = os.getenv(
        "TRAIN_LABELS_PATH", 
        "C:\\Personal\\Bosch_assignment\\assignment_data_bdd_files\\bdd100k_labels_release\\bdd100k\\labels\\bdd100k_labels_images_train.json")
    VAL_LABELS_PATH = os.getenv(
        "VAL_LABELS_PATH", 
